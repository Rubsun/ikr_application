...
class MyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.text).apply {
            ...
            text = getString(R.string.tire_text_time_pattern, date)
        }
        ...
        view.findViewById<ViewGroup>(R.id.buttons).apply {
            viewModel.timePrecisions()
                .map { item ->
                    layoutInflater
                        .inflate(R.layout.item_tire_precision, this, false)
                        .apply {
    ...
    private fun applyPrecision(elapsed: TextView, item: TimePrecisions) {
        ...
        elapsed.text = getString(R.string.tire_text_time_from_reboot_pattern, time)
    }
}
