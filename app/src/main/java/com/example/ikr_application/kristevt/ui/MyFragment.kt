...
class KristevtFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.kristevt_curtimetext).apply {
            val date = viewModel.date()
            text = getString(R.string.text_time_pattern, date)
        }

        val elapsed = view.findViewById<TextView>(R.id.kristevt_timeelapsed)
        view.findViewById<ViewGroup>(R.id.kristevt_buttons).apply {
            viewModel.timePrecisions()
                .map { item ->
                    layoutInflater
                        .inflate(R.layout.item_kristevt_precision, this, false)
                        .apply {
