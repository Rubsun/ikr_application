...
- Создать свой "пакет" и добавить туда три подпакета:
    - **data**, **domain**, **ui**
- В своем пакете, в data, создать **Repository**:
    - В него можно добавить данные
    - Он может отдать список данных
- В своем пакете, в domain, создать несколько **UseCase** которе должны будут из Repository брать данные и преобразовывать к обычным данным (если преобразование потребуется)
...
- Экран должен будет получать данные для отображения через flow
- На экране можно будет завести данные, которые должны будут через ViewModel + UseCase добавиться в репощиторий

## Полезные ссылки
- **Presentation Domain Data Layering** - https://martinfowler.com/bliki/PresentationDomainDataLayering.html
- (Для ознакомления) **Kotlin flows on Android** - https://developer.android.com/kotlin/flow
