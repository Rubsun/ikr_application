...
import com.drain678.impl.ui.adapters.TimeRecordAdapter
import com.google.android.material.button.MaterialButton
import com.google.android.material.textfield.TextInputEditText
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.launch

internal class Drain678Fragment : Fragment() {
    ...
    private fun applyState(
        ...
        textView.text = getString(R.string.drain678_text_time_pattern, state.currentDate)

        if (state.elapsedTime.isNotEmpty()) {
            elapsedTextView.text = getString(
                R.string.drain678_text_time_from_reboot_pattern,
                state.elapsedTime
            )
        }
